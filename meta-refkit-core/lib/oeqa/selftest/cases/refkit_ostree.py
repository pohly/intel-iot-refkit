...
class RefkitOSTreeUpdateTest(OESelftestTestCase, SystemUpdateBase):
    """
    System update tests for refkit-image-common using OSTree.
    """

    # We test the -ostree image variant of the normal
    # refkit-image-common.
    IMAGE_PN = 'refkit-image-common-ostree'
    ...
    def boot_image(self, overrides):
        ...
        qemuboot_conf = os.path.join(self.image_dir_original,
    ...
    def update_image(self, qemu):
        ...
        # OSTree repo. We cannot get the actual OSTREE_EXPORT for the
        ...
        try:
            ...
            bb.note('serving OSTree repo %s on port %d' % (ostree_repo, port))
