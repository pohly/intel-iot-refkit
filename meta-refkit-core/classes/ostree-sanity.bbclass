...
# TODO: use it once available, nicer?
# if oe.utils.all_distro_features(d, "ostree") and \
#       not oe.utils.all_distro_features(d, "usrmerge"):
   if bb.utils.contains("DISTRO_FEATURES", "ostree", True, False, d) and \
       not bb.utils.contains("DISTRO_FEATURES", "usrmerge", True, False, d):
